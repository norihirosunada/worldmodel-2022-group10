...
class GymWrapperPyBullet(object):
    """
    PyBullet環境のためのラッパー
    """
...
def make_env(name: str):
    """Create an instance of environment with specified name.
    Args:
    ...
    # TODO: Change for maze or custom environment
    env = GymWrapperPyBullet(env, cam_dist=2, cam_pitch=0, render_width=64, render_height=64)
